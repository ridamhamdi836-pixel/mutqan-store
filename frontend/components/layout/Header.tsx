...
export function Header() {
  ...
  return (
    <header className="store-chrome sticky top-0 z-30 bg-white border-b border-brand-border/60 shadow-sm max-md:relative max-md:shadow-none max-md:transform-none">
