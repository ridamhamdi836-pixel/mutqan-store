...
export function TermsPageContent() {
  const { market, locale } = useStorefront();
  ...
  const sections = [
    {
      title: "الطلب والدفع",
      content: `جميع الطلبات تتم بالدفع عند الاستلام ب${currencyLabel}. الأسعار شاملة ضريبة القيمة المضافة ما لم يُذكر غير ذلك. يُؤكد الطلب بعد التواصل معك من فريق متقن.`,
    },
    {
    ...
    {
      title: "التوصيل",
      content: `نوصل داخل ${countryName} فقط حاليًا. مدة التوصيل 2-5 أيام عمل في المدن الرئيسية. العميل مسؤول عن تقديم عنوان ورقم جوال صحيحين لضمان التوصيل السليم.`,
    },
    {
