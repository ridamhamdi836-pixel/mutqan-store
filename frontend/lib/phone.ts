...
/** Accepts any phone with 7–15 digits (mobile, landline, international prefix) */
...
export function normalizeSaudiPhone(raw: string): string {
  return normalizePhone(raw, "SA").e164;
}
