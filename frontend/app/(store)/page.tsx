        ...
        <div className="max-w-content mx-auto relative z-10">
          <div className="grid md:grid-cols-2 gap-12 md:gap-20 items-center">
            ...
            <div className="order-1 md:order-2 relative mb-8 md:mb-0">
              ...
              <div className="absolute -bottom-4 start-2 md:-bottom-5 md:-start-6 z-10 bg-white p-3 md:p-4 rounded-xl shadow-xl border border-gray-100 flex items-center gap-3 animate-float">
