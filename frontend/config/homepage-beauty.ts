    ...
    cards: [
      {
        ...
        desc: "كل منتج تم اختياره بعناية ليقدم تجربة تستحقينها.",
      },
      {
        title: "جودة تدوم",
        desc: "خامات عالية الجودة وتصاميم أنيقة.",
      },
      {
        title: "ضمان ذهبي 30 يوم",
        desc: "استبدال أو استرجاع بكل راحة.",
      },
      {
        title: "خدمة عملاء حقيقية",
        desc: "فريق جاهز لخدمتك قبل وبعد الطلب.",
      },
    ],
  },
