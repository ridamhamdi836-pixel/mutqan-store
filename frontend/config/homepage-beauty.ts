...
export const HOMEPAGE_BEAUTY = {
    ...
    items: [
      {
        ...
        age: "29",
        rating: 5,
        text: "كنت أدور على سيروم يعطي إشراقة حقيقية بدون ما يهيج بشرتي. بعد استخدام سيروم فيتامين C مع النياسيناميد، بدأت البقع الداكنة تخف تدريجيًا وصارت بشرتي أوحد وأنضر. أكثر شيء عجبني إن البشرة تعطي Glow طبيعي من غير أي إحساس بالثقل.",
        verified: true,
      },
      {
        name: "سارة الحربي",
        ...
        age: "34",
        rating: 5,
        text: "الحبوب الصغيرة وجلد الدجاجة في الذراعين كانت مزعجتني من سنوات. بعد فترة من استخدام سيروم السنتيلا والسيراميد صار الجلد أنعم بشكل واضح، والاحمرار خف كثير. الترطيب فيه ممتاز وما يترك أي ملمس دهني.",
        verified: true,
      },
      {
        name: "ريم العتيبي",
        ...
        age: "41",
        rating: 5,
        text: "كنت أبحث عن منتج يساعد على تحسين مظهر الخطوط الدقيقة والتجاعد بدون روتين معقد. سيروم PDRN مع الببتيدات أعطى بشرتي امتلاء ونعومة، وصارت أكثر مرونة مع الاستخدام المستمر. حتى المكياج صار يثبت بشكل أجمل على البشرة.",
        verified: true,
      },
    ],
  },
  ...
  orderSteps: {
    ...
    steps: [
      {
        title: "اختاري روتينك",
        desc: "ثلاث سيرومات تستهدف ثلاث مشاكل: الإشراقة والبقع، الحبوب والترطيب، أو التجاعيد والخطوط. اختاري واحداً أو الروتين الكامل.",
      },
      {
