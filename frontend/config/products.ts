...
export const PRODUCTS_CONFIG: Record<string, {
  ...
  "smart-stackable-cabinet": {
    heroImageAlt: "الخزانة التراكمية الذكية في ركن التخزين",
  ...
  "pull-out-cabinet-drawer": {
    ...
    faqs: [
      { question: "كيف أعرف أنها تناسب خزانتي؟", answer: "قيسي عرض الخزانة الداخلي. فريق التأكيد يساعدك للتأكد قبل الشحن." },
  ...
  "magic-under-sink-organizer": {
    heroImageAlt: "منظّم المغسلة السحري — رف سحب مزدوج مع أبعاد 28×40×39 سم",
    ...
    reviews: [
      ...
      { name: "بشاير العجمي", city: "الخبر", rating: 5, text: "المواسير ما أثرت أبداً. المنظم التف حولها بسهولة. تصميم ذكي فعلاً." },
