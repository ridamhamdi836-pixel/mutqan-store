...
export const PRODUCTS_CONFIG: Record<string, {
  ...
  "pull-out-cabinet-drawer": {
    ...
    reviews: [
      { name: "نورة العنزي", city: "الرياض", rating: 5, text: "أكثر شيء فرق معي أن الأشياء اللي كانت في آخر الخزانة صارت سهلة الوصول. ممتازة جدًا." },
      { name: "فوز الدوسري", city: "الخبر", rating: 5, text: "طلبت 4 قطع للمطبخ. الفرق كبير جدًا في الترتيب والوصول للبهارات والأواني." },
      { name: "ابتسام الحربي", city: "الدمام", rating: 4, text: "تركيبها سهل جدًا والانزلاق سلس. راضية جدًا عن الشراء." },
      { name: "وجدان المالكي", city: "جدة", rating: 5, text: "كل الخزائن صارت منظمة. البهارات والأواني كلها بمتناول اليد بدون أي جهد." },
      { name: "نجلاء الزهراني", city: "مكة", rating: 5, text: "أخذت 6 قطع للبيت كامل. صراحة أفضل شيء سويته للمطبخ من سنوات." },
      { name: "رنا الشريف", city: "حائل", rating: 5, text: "حتى زوجي لاحظ الفرق في المطبخ. الانزلاق ناعم والجودة عالية." },
    ],
    faqs: [
  ...
  "smart-table-warmer": {
    ...
    reviews: [
      { name: "أم خالد", city: "الرياض", rating: 5, text: "مثالي للعزوم والعائلة. الطعام يبقى دافئ من بداية الجلسة للآخر. ممتاز ومريح جدًا." },
      { name: "شيخة المري", city: "جدة", rating: 5, text: "أشكر متقن على هذا المنتج. جلساتنا العائلية صارت أجمل. الطعام يبقى كما هو." },
      { name: "مشاعل الدوسري", city: "الخبر", rating: 5, text: "العزايم صارت أحلى بكثير. الضيوف دائماً يسألون عنه." },
      { name: "أم فيصل", city: "الرياض", rating: 5, text: "طلبت قطعتين وما ندمت. كل يوم نستخدمه في العشاء العائلي." },
