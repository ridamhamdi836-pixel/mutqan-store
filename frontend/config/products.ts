...
export const PRODUCTS_CONFIG: Record<string, ProductPageConfig> = {
  ...
  "vitamin-c-booster": {
    heroImageAlt: "معزّز فيتامين سي — متقن",
    shortPromise: "إشراقة طبيعية وبشرة أكثر توحيداً.",
    heroAngle: "توهج يبدأ من خطوة واحدة هادئة",
    problemStatement: "بشرة باهتة رغم الروتين؟ الإشراقة تحتاج تركيزاً مركزاً.",
    heroSectionImage: "/images/products/vitamin-c-booster.png",
    heroSectionImageAlt: "معزّز فيتامين سي — متقن",
    benefits: ["إشراقة طبيعية", "مظهر موحّد", "ملمس خفيف", "روتين بسيط"],
    beforeLabel: "قبل",
    afterLabel: "بعد",
    howToUse: ["نظّفي البشرة", "2-3 قطرات", "دلّكي بلطف", "مرطب وواقي شمس"],
    ...
    seoTitle: "معزّز فيتامين سي | متقن",
    seoDescription: "إشراقة وتوحيد لون البشرة. عناية كورية فاخرة مع الدفع عند الاستلام.",
  },
  "ceramide-booster": {
    heroImageAlt: "معزّز السيراميد — متقن",
    shortPromise: "إصلاح الحاجز وترطيب عميق.",
    heroAngle: "راحة البشرة تبدأ من الداخل",
    problemStatement: "جفاف وتوتر رغم المرطب؟ الحاجز يحتاج إصلاحاً مركزاً.",
    heroSectionImage: "/images/products/ceramide-booster.png",
    heroSectionImageAlt: "معزّز السيراميد — متقن",
    benefits: ["حاجز أقوى", "ترطيب يدوم", "بشرة هادئة", "ملمس ناعم"],
    beforeLabel: "قبل",
    afterLabel: "بعد",
    howToUse: ["نظّفي مساءً", "2-3 قطرات", "دلّكي بلطف", "مرطب ليلي"],
    ...
    seoTitle: "معزّز السيراميد | متقن",
    seoDescription: "إصلاح وترطيب للبشرة الحساسة. عناية كورية فاخرة.",
  },
  "pdrn-booster": {
    heroImageAlt: "معزّز PDRN — متقن",
    shortPromise: "مرونة أعلى ومظهر أنعم.",
    heroAngle: "شباب يبدأ من عناية مركزة",
    problemStatement: "خطوط دقيقة وفقدان مرونة؟ البشرة تحتاج دعماً مركزاً.",
    heroSectionImage: "/images/products/pdrn-booster.png",
    heroSectionImageAlt: "معزّز PDRN — متقن",
    benefits: ["مرونة أعلى", "خطوط أقل وضوحاً", "حيوية تعود", "ثقة في كل عمر"],
    beforeLabel: "قبل",
    afterLabel: "بعد",
    howToUse: ["نظّفي البشرة", "2-3 قطرات", "دلّكي صاعداً", "مرطب وواقي شمس"],
    ...
    seoTitle: "معزّز PDRN | متقن",
    seoDescription: "شد ومرونة للبشرة. عناية كورية فاخرة للشباب.",
  },
};
