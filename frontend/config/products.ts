...
export const PRODUCTS_CONFIG: Record<string, {
  ...
  "thermal-lunch-box": {
    ...
    heroSectionImageAlt: "رجل سعودي في المكتب مع ساعة على الحائط — وجبة في الدوام",
    heroSectionAspect: "1024/682",
    ...
    beforeSectionImageAlt: "رجل سعودي في المكتب يتناول وجبة من حافظة الغداء الحرارية",
    beforeSectionAspect: "1024/682",
    afterLabel: "بعد متقن: وجبة دافئة أينما كنت",
    afterSectionImage: "/images/products/thermal-lunch-box-after.png",
    afterSectionImageAlt: "رجل سعودي في المكتب مع ساعة على الحائط — وجبة دافئة من حافظة الغداء الحرارية",
