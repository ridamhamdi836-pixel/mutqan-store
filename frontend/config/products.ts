...
export const PRODUCTS_CONFIG: Record<string, ProductPageConfig> = {
  ...
  "vitamin-c-booster": {
    heroImageAlt: "سيروم فيتامين سي ونياسيناميد ضد البقع والبهتان — متقن",
    ...
    seoTitle: "سيروم فيتامين سي ونياسيناميد ضد البقع | متقن",
    seoDescription: "سيروم فيتامين سي ونياسيناميد ضد البقع والبهتان. عناية كورية مع الدفع عند الاستلام.",
  },
  "ceramide-booster": {
    heroImageAlt: "سيروم السنتيلا والسيراميد ضد الحبوب — متقن",
    ...
    seoTitle: "سيروم السنتيلا والسيراميد ضد الحبوب | متقن",
    seoDescription: "سيروم سنتيلا وسيراميد ضد الحبوب وجلد الدجاجة. عناية كورية للبشرة الحساسة.",
  },
  "pdrn-booster": {
    heroImageAlt: "سيروم PDRN والببتيدات ضد التجاعيد — متقن",
    ...
    seoTitle: "سيروم PDRN والببتيدات ضد التجاعيد | متقن",
    seoDescription: "سيروم PDRN وببتيدات ضد التجاعيد والخطوط الدقيقة. عناية كورية للشباب.",
  },
};
