...
export const PRODUCTS_CONFIG: Record<string, {
  ...
  "thermal-lunch-box": {
    ...
    painSectionAspect: "1024/379",
    solutionSectionImage: "/images/products/thermal-lunch-box-after.png",
    solutionSectionImageAlt: "حافظة الغداء الحرارية — وجبة دافئة مع بخار في المكتب",
    solutionSectionAspect: "819/1024",
    benefits: [
